...
for PARTICIPANT_AGE in range(66,75):

    # This is the target log quantal radiance, chosen because it is achieveable for
    # ages ranged 20 - 65 after lens filtering
    target_log_quanta = 17.65
    
    # %%
    right_cal = r"C:\Users\jmarti2\OneDrive - University of Edinburgh\RetinaWISE\Calibration\Custom_Calibration_02092024\right_spds.csv"
    ...
    out_dir = rf"C:\Users\jmarti2\OneDrive - University of Edinburgh\AMBIENT-BD\Protocols\HELIOS-BD\PIPR\{PARTICIPANT_AGE}"
